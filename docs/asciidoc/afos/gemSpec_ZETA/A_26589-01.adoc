...
Folgende Claims des Access Tokens gehören zu den Nutzer-Daten und werden gemäß Tabelle in den `zeta-user-info` Header übernommen.

Tabelle #: zeta-user-info-Header
