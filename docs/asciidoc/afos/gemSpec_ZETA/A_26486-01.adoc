...
PEP Latenzen sind die Zeiten, die der PEP benötigt, um die Anfragen an den Fachdienst weiterzuleiten, bzw. die Response eben zurück durchzuleiten.
Die Benennung als Latenz erfolgt aufgrund der Tatsache, dass der PEP hier Requests nur durchleitet, die eigentliche Beantwortung erfolgt durch den Fachdienst.
...
Tabelle #: Tab_gemSpec_ZETA_PEP_HTTP_Proxy: Bearbeitungszeitvorgaben
