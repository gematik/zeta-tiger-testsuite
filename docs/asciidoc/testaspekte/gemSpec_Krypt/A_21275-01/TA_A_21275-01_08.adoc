[#TA_A_21275-01_08]
===== TA_A_21275-01_08 - TLS-Verbindungen, zulässige Hashfunktionen bei Signaturen im TLS-Handshake - ZETA Client - ausschließlich und keine anderen Hashfunktionen
