 ...
 * @param wellKnownAslDisabledValue Value to be set in the well-known config to disable ASL
 */
public record ZetaDisableAslRequest(String nginxAslRegex,
                                    String wellKnownAslRegex,
                                    String wellKnownAslDisabledValue) {
}
