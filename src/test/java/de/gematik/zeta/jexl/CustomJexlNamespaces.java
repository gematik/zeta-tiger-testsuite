...
/**
 * Configuration point for custom Tiger JEXL namespaces.
 */
public final class CustomJexlNamespaces {

  private CustomJexlNamespaces() {
    // utility
  }
  ...
  public static Map<String, Object> namespaces() {
    ...
    namespaces.put("achelos", CustomJexlNamespace.INSTANCE);
    return namespaces;
  }
}
