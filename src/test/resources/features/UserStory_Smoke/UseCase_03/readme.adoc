...
| Vorbedingung: |
WebSocket-Endpunkt ``${paths.client.websocketBaseUrl}`` ist erreichbar, Testfachdienst subscribt auf die relevanten Channels.
Vor STOMP-Nutzung prüft die Testsuite zuerst den reinen WebSocket-Upgrade (Transport), um Transport- von STOMP-Fehlern zu trennen.
